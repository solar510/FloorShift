...
import com.floor.shift.ui.slidemenu.SlidingMenu.OnClosedListener;
import com.floor.shift.ui.slidemenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	float distanceInfluenceForSnapDuration(float f) {
		...
		f *= 0.3f * Math.PI / 2.0f;
		return (float) FloatMath.sin(f); //FloatMath.sin(f);
	}
